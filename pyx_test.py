#from pyx import path, canvas, style, text
#
#TEST_CANVAS = canvas.canvas()
## arc = path.path(path.arc(0,0,5,0,45))
#TEST_CANVAS.text(-5, 5, r"boxleft", [text.halign.boxleft])
#TEST_CANVAS.writePDFfile("path")
