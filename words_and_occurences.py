"""
A list of tuples, the first element being the word and the second being its
frequency. There are 5000 entries corresponding to the 5000 most used words in
English.
...
words_and_occurences  = [('the', 22038615),
                         ('be', 12545825),
                         ('and', 10741073),
                         ('of', 10343885),
                         ('a', 10144200),
...
def sanitize_word_list(word_list, maxsize):
    ...
    for entry in word_list:
        ...
        if len(sanitized_list) > maxsize:
            break
    return sanitized_list


word_list = sanitize_word_list(words_and_occurences, 5000)
